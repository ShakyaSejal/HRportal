...
const DonutChart = () => {
  ...
  return (
    <div className="max-w-sm w-full bg-white rounded-lg shadow  p-4 md:p-6 flex-1">
        ...
        <div className="flex justify-center items-center">
          ...
          >
            <div className="p-3 space-y-2">
              ...
              <p>Report helps navigate cumulative growth of community activities. Ideally, the chart should have a growing trend, as stagnating chart signifies a significant decrease in community activity.</p>
